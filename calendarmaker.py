...
print("Calendar Maker, by allen-rossum")
...
def getCalendarFor(year,month):
    calText = " " #CalText will contain the string of the calendar
    ...
    #Get the first date in the month. (The datetime module handles all the complicated calendar stuff)
    ...
    while True: #Loop over each week in the month
        ...
        #dayNumberRow is the row with the day number lables
        dayNumberRow = " "
        for i in range(7):
